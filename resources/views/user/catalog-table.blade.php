        ...
        <div class="section-cont">
            ...
            <div class="section-top">
                ...
                <ul class="section-mode">
                    ...
                    <li class="section-mode-table active"><a title="View mode: Table" href="catalog-table.html"></a></li>
                </ul>
            ...
            <div class="prod-items section-items prod-tb">
                <div class="prodtb-i">
                    <div class="prodtb-i-top">
                        ...
                        <h3 class="prodtb-i-ttl"><a href="product.html">Adipisci aperiam commodi</a></h3>
                        ...
                        <p class="prodtb-i-action">
                            <a href="#" class="prodtb-i-favorites"><span>Wishlist</span><i class="fa fa-heart"></i></a>
                            <a class="prodtb-i-compare" href="#"><span>Compare</span><i class="fa fa-bar-chart"></i></a>
                            <a href="#" class="qview-btn prodtb-i-qview"><span>Quick View</span><i class="fa fa-search"></i></a>
                            <a href="#" class="prodtb-i-buy"><span>Add to cart</span><i class="fa fa-shopping-basket"></i></a>
                        </p>
                    </div>
                    <div class="prodlist-i">
                        <a class="list-img-carousel prodlist-i-img" href="product.html"><!-- NO SPACE --><img src="http://placehold.it/300x311" alt="Adipisci aperiam commodi"><img src="http://placehold.it/300x322" alt="Adipisci aperiam commodi"><img src="http://placehold.it/300x433" alt="Adipisci aperiam commodi"><img src="http://placehold.it/300x433" alt="Adipisci aperiam commodi"><!-- NO SPACE --></a>
                ...
                <div class="prodtb-i">
                    <div class="prodtb-i-top">
                        <button class="prodtb-i-toggle" type="button"></button>
                        <h3 class="prodtb-i-ttl"><a href="product.html">Nulla numquam obcaecati</a></h3>
                        <div class="prodtb-i-info">
                        <span class="prodtb-i-price">
                            <b>$48</b>
                                                    </span>
                    ...
                    <div class="prodlist-i">
                        <a class="list-img-carousel prodlist-i-img" href="product.html"><!-- NO SPACE --><img src="http://placehold.it/300x366" alt="Nulla numquam obcaecati"><img src="http://placehold.it/300x433" alt="Nulla numquam obcaecati"><img src="http://placehold.it/300x433" alt="Nulla numquam obcaecati"><img src="http://placehold.it/300x433" alt="Nulla numquam obcaecati"><!-- NO SPACE --></a>
                        <div class="prodlist-i-cont">
                            <div class="prodlist-i-txt">
                ...
                <div class="prodtb-i">
                    <div class="prodtb-i-top">
                        <button class="prodtb-i-toggle" type="button"></button>
                        <h3 class="prodtb-i-ttl"><a href="product.html">Dignissimos eaque earum</a></h3>
                        <div class="prodtb-i-info">
                        <span class="prodtb-i-price">
                            <b>$37</b>
                                                    </span>
                    ...
                    <div class="prodlist-i">
                        <a class="list-img-carousel prodlist-i-img" href="product.html"><!-- NO SPACE --><img src="http://placehold.it/370x300" alt="Dignissimos eaque earum"><img src="http://placehold.it/300x333" alt="Dignissimos eaque earum"><img src="http://placehold.it/308x300" alt="Dignissimos eaque earum"><img src="http://placehold.it/300x433" alt="Dignissimos eaque earum"><!-- NO SPACE --></a>
                        <div class="prodlist-i-cont">
                            <div class="prodlist-i-txt">
                ...
                <div class="prodtb-i">
                    <div class="prodtb-i-top">
                        <button class="prodtb-i-toggle" type="button"></button>
                        <h3 class="prodtb-i-ttl"><a href="product.html">Porro quae quasi</a></h3>
                        <div class="prodtb-i-info">
                        <span class="prodtb-i-price">
                            <b>$85</b>
                                                            <del>$110</del>
                    ...
                    <div class="prodlist-i">
                        <a class="list-img-carousel prodlist-i-img" href="product.html"><!-- NO SPACE --><img src="http://placehold.it/300x345" alt="Porro quae quasi"><img src="http://placehold.it/300x433" alt="Porro quae quasi"><img src="http://placehold.it/300x433" alt="Porro quae quasi"><img src="http://placehold.it/300x433" alt="Porro quae quasi"><!-- NO SPACE --></a>
                        <div class="prodlist-i-cont">
                            <div class="prodlist-i-txt">
                ...
                <div class="prodtb-i">
                    <div class="prodtb-i-top">
                        <button class="prodtb-i-toggle" type="button"></button>
                        <h3 class="prodtb-i-ttl"><a href="product.html">Sunt temporibus velit</a></h3>
                        <div class="prodtb-i-info">
                        <span class="prodtb-i-price">
                            <b>$115</b>
                                                    </span>
                    ...
                    <div class="prodlist-i">
                        <a class="list-img-carousel prodlist-i-img" href="product.html"><!-- NO SPACE --><img src="http://placehold.it/378x300" alt="Sunt temporibus velit"><img src="http://placehold.it/398x300" alt="Sunt temporibus velit"><img src="http://placehold.it/300x433" alt="Sunt temporibus velit"><img src="http://placehold.it/300x433" alt="Sunt temporibus velit"><img src="http://placehold.it/300x433" alt="Sunt temporibus velit"><!-- NO SPACE --></a>
                        <div class="prodlist-i-cont">
                            <div class="prodlist-i-txt">
                ...
                <div class="prodtb-i">
                    <div class="prodtb-i-top">
                        <button class="prodtb-i-toggle" type="button"></button>
                        <h3 class="prodtb-i-ttl"><a href="product.html">Harum illum incidunt</a></h3>
                        <div class="prodtb-i-info">
                        <span class="prodtb-i-price">
                            <b>$130</b>
                                                    </span>
                    ...
                    <div class="prodlist-i">
                        <a class="list-img-carousel prodlist-i-img" href="product.html"><!-- NO SPACE --><img src="http://placehold.it/300x394" alt="Harum illum incidunt"><img src="http://placehold.it/300x433" alt="Harum illum incidunt"><img src="http://placehold.it/300x433" alt="Harum illum incidunt"><img src="http://placehold.it/300x433" alt="Harum illum incidunt"><!-- NO SPACE --></a>
                        <div class="prodlist-i-cont">
                            <div class="prodlist-i-txt">
                ...
                <div class="prodtb-i">
                    <div class="prodtb-i-top">
                        <button class="prodtb-i-toggle" type="button"></button>
                        <h3 class="prodtb-i-ttl"><a href="product.html">Reprehenderit rerum</a></h3>
                        <div class="prodtb-i-info">
                        <span class="prodtb-i-price">
                            <b>$210</b>
                                                            <del>$240</del>
                    ...
                    <div class="prodlist-i">
                        <a class="list-img-carousel prodlist-i-img" href="product.html"><!-- NO SPACE --><img src="http://placehold.it/300x303" alt="Reprehenderit rerum"><img src="http://placehold.it/300x317" alt="Reprehenderit rerum"><img src="http://placehold.it/300x433" alt="Reprehenderit rerum"><!-- NO SPACE --></a>
                        <div class="prodlist-i-cont">
                            <div class="prodlist-i-skuwrap">
                                <div class="prodlist-i-skuitem">
                                    <p class="prodlist-i-skuttl">Color</p>
                ...
                <div class="prodtb-i">
                    <div class="prodtb-i-top">
                        <button class="prodtb-i-toggle" type="button"></button>
                        <h3 class="prodtb-i-ttl"><a href="product.html">Quae quasi adipisci alias</a></h3>
                        <div class="prodtb-i-info">
                        <span class="prodtb-i-price">
                            <b>$85</b>
                                                    </span>
                ...
                <div class="prodtb-i">
                    <div class="prodtb-i-top">
                        <button class="prodtb-i-toggle" type="button"></button>
                        <h3 class="prodtb-i-ttl"><a href="product.html">Maxime molestias necessitatibus nobis</a></h3>
                        <div class="prodtb-i-info">
                        <span class="prodtb-i-price">
                            <b>$95</b>
                                                    </span>
                    ...
                    <div class="prodlist-i">
                        <a class="list-img-carousel prodlist-i-img" href="product.html"><!-- NO SPACE --><img src="http://placehold.it/300x416" alt="Maxime molestias necessitatibus nobis"><img src="http://placehold.it/300x433" alt="Maxime molestias necessitatibus nobis"><img src="http://placehold.it/300x433" alt="Maxime molestias necessitatibus nobis"><img src="http://placehold.it/300x433" alt="Maxime molestias necessitatibus nobis"><!-- NO SPACE --></a>
                        <div class="prodlist-i-cont">
                            <div class="prodlist-i-txt">
                ...
                <div class="prodtb-i">
                    <div class="prodtb-i-top">
                        <button class="prodtb-i-toggle" type="button"></button>
                        <h3 class="prodtb-i-ttl"><a href="product.html">Facilis illum</a></h3>
                        <div class="prodtb-i-info">
                        <span class="prodtb-i-price">
                            <b>$150</b>
                                                            <del>$180</del>
                    ...
                    <div class="prodlist-i">
                        <a class="list-img-carousel prodlist-i-img" href="product.html"><!-- NO SPACE --><img src="http://placehold.it/300x480" alt="Facilis illum"><img src="http://placehold.it/300x433" alt="Facilis illum"><img src="http://placehold.it/300x433" alt="Facilis illum"><img src="http://placehold.it/300x433" alt="Facilis illum"><!-- NO SPACE --></a>
                        <div class="prodlist-i-cont">
                            <div class="prodlist-i-txt">
                ...
                <div class="prodtb-i">
                    <div class="prodtb-i-top">
                        <button class="prodtb-i-toggle" type="button"></button>
                        <h3 class="prodtb-i-ttl"><a href="product.html">Iusto labore laudantium</a></h3>
                        <div class="prodtb-i-info">
                        <span class="prodtb-i-price">
                            <b>$170</b>
                                                    </span>
                    ...
                    <div class="prodlist-i">
                        <a class="list-img-carousel prodlist-i-img" href="product.html"><!-- NO SPACE --><img src="http://placehold.it/358x300" alt="Iusto labore laudantium"><img src="http://placehold.it/315x300" alt="Iusto labore laudantium"><img src="http://placehold.it/300x433" alt="Iusto labore laudantium"><img src="http://placehold.it/300x433" alt="Iusto labore laudantium"><!-- NO SPACE --></a>
                        <div class="prodlist-i-cont">
                            <div class="prodlist-i-txt">
                ...
                <div class="prodtb-i">
                    <div class="prodtb-i-top">
                        <button class="prodtb-i-toggle" type="button"></button>
                        <h3 class="prodtb-i-ttl"><a href="product.html">Fuga impedit inciduntipsa</a></h3>
                        <div class="prodtb-i-info">
                        <span class="prodtb-i-price">
                            <b>$80</b>
                                                    </span>
                    ...
                    <div class="prodlist-i">
                        <a class="list-img-carousel prodlist-i-img" href="product.html"><!-- NO SPACE --><img src="http://placehold.it/300x504" alt="Fuga impedit inciduntipsa"><!-- NO SPACE --></a>
                        <div class="prodlist-i-cont">
                            <div class="prodlist-i-txt">
