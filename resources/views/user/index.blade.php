...
<head>
    ...
    <link rel="stylesheet" href="user/css/swiper.css">
    <link rel="stylesheet" href="user/css/style.css">
    <link rel="stylesheet" href="user/css/media.css">
    ...
    <section class="container">
        ...
        <div class="fr-slider-wrap">
            <div class="fr-slider">
                <ul class="slides">
                    <li>
                        <img src="user/img/slider/slide1.jpg" alt="">
                        ...
                        <li class="prod-i">
                            ...
                            <div class="prod-i-skuwrapcolor">
                                <ul class="prod-i-skucolor">
                                    <li class="bx_active"><img src="user/img/color/red.jpg" alt="Red"></li>
                                    <li><img src="user/img/color/blue.jpg" alt="Blue"></li>
                                </ul>
                            </div>
                        </li>
                        <li class="prod-i">
                ...
                <div class="prod-cont">
                    ...
                    <div class="prod-skuwrap">
                        ...
                        <ul class="prod-skucolor">
                            <li class="active">
                                <img src="user/img/color/blue.jpg" alt="">
                            </li>
                            <li>
                                <img src="user/img/color/red.jpg" alt="">
                            </li>
                            <li>
                                <img src="user/img/color/green.jpg" alt="">
                            </li>
                            <li>
                                <img src="user/img/color/yellow.jpg" alt="">
                            </li>
                            <li>
                                <img src="user/img/color/purple.jpg" alt="">
                            </li>
                        </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="companyinfo">
                    <a href="index.html">
                        <img src="user/img/logo-b.png" alt="AllStore - MultiConcept eCommerce Responsive HTML5 Template">
...
<script src="user/js/fancybox/fancybox.js"></script>
<script src="user/js/fancybox/helpers/jquery.fancybox-thumbs.js"></script>
<script src="user/js/jquery.flexslider-min.js"></script>
<script src="user/js/swiper.jquery.min.js"></script>
<script src="user/js/jquery.waypoints.min.js"></script>
<script src="user/js/progressbar.min.js"></script>
<script src="user/js/ion.rangeSlider.min.js"></script>
<script src="user/js/chosen.jquery.min.js"></script>
<script src="user/js/jQuery.Brazzers-Carousel.js"></script>
<script src="user/js/plugins.js"></script>
<script src="user/js/main.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDhAYvx0GmLyN5hlf6Uv_e9pPvUT3YpozE"></script>
<script src="user/js/gmap.js"></script>
